...
class FieldMapping(Enum):
    CPN = ("chassis", "Chassis Part Number")
    CSN = ("chassis", "Chassis Serial Number")
    ...
    BSN = ("board", "Board Serial")
    BPN = ("board", "Board Part Number")
    BFI = ("board", "Board FRU ID")
    BCD1 = ("board", "Board Custom Data 1")
    BCD2 = ("board", "Board Custom Data 2")
    BCD3 = ("board", "Board Custom Data 3")
    BCD4 = ("board", "Board Custom Data 4")
    BCD5 = ("board", "Board Custom Data 5")
    BCD6 = ("board", "Board Custom Data 6")
    PM = ("product", "Product Manufacturer")
    PN = ("product", "Product Name")
    PPN = ("product", "Product Part Number")
    PV = ("product", "Product Version")
    PSN = ("product", "Product Serial")
    PAT = ("product", "Product Asset Tag")
    PFI = ("product", "Product FRU ID")
    PCD1 = ("product", "Product Custom Data 1")
    PCD2 = ("product", "Product Custom Data 2")
    PCD3 = ("product", "Product Custom Data 3")
    PCD4 = ("product", "Product Custom Data 4")
    PCD5 = ("product", "Product Custom Data 5")
    PCD6 = ("product", "Product Custom Data 6")
